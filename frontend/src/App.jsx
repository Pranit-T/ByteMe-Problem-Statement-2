    ...
    const renderResponseContent = (response, type) => {
        ...
        return (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                <div
                    className={`prose prose-invert max-w-none text-white/90 text-sm leading-relaxed p-6 rounded-2xl border backdrop-blur-sm shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] ${type === 'expert' ? 'bg-[#00D7D2]/10 border-[#00D7D2]/20' : 'bg-black/60 border-white/20'}`}>
